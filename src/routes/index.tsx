      ...
      <div className="mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-5 pb-14 pt-32 sm:justify-center sm:pb-24 sm:pt-32 opacity-65">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="group inline-flex h-14 items-center justify-center gap-3 rounded-full bg-whatsapp text-base font-medium text-white shadow-lg shadow-whatsapp/30 transition hover:bg-whatsapp-dark sm:px-7 px-[16px] mx-[24px]"
          >
